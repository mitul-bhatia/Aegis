...
# Model selection
# Model-agnostic default for Aegis. Override with RALPH_MODEL or -m.
# Interactive Cursor Agent may use Grok 4.5; overnight CLI often uses Composer.
DEFAULT_MODEL="${RALPH_DEFAULT_MODEL:-composer-2}"
