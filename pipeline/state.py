...
class AegisPipelineState(TypedDict):
    ...
    patched_code: str | None   # the patch for the current vulnerability
    test_code: str | None      # the test file for the current vulnerability
    original_code: str | None  # the original vulnerable code (for diff view)
    ...
    safety_report: dict | None # output of the Safety Validator node
